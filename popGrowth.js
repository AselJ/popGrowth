...
function popGrowth(pO, percent, aug, p) {
  let currentPop = pO
  let years = 0;
  while(currentPop < p){
    currentPop += (pO * (percent/100) + aug)
    years++
  }
  return years;
}
console.log(popGrowth(1500, 5, 100, 5000)) // 15

console.log(popGrowth(1500000, 2.5, 10000, 2000000)) // 10